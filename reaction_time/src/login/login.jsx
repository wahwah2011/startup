        ...
        <div className="col-12">
          ...
          <div id="user-display" className="card info-card mt-3">
            <div className="card-body text-center">
              <p className="mb-0">Logged in as: <span id="username" className="fw-bold">Guest</span></p>
            </div>
          </div>
          ...
          <div id="active-users" className="card info-card mt-3">
            <div className="card-body text-center">
              <p className="mb-0">Chemists online: <span id="online-count" className="badge bg-success">3</span></p>
            </div>
          </div>
        </div>
      </div>
